...
## On-Screen Text
Cream serif title (Cormorant Garamond, cream #f4ecdb, NOT pure white) + karaoke captions
(Archivo bold, cream, black outline, active word in an emerald box). Most watch on mute.
Emerald spine + dusk glow + grain per `DESIGN-SYSTEM.md`.
...
> #solofemaletravel #solotraveltips
