# Reel/Carousel 02 - "The first 30 minutes if your phone is stolen abroad"

**Quelle:** Post #7 aus dem Notion-10-Post-Plan (Angle: "Zeitachse = starker Save",
Playbook-Quelle: Notfall-Kaskade / "If it happens I").
**Hook-Formel (Notion-Daten):** Zahl + Nische + Save-Trigger. Poetische Hooks floppen
(24-61 Views), Listen-Hooks laufen (1.000-1.700 Views).
**Hormozi (Hooks-Playbook):** Call-out ("this is for me") + Wert-Bedingung ("if you
watch this, you get X"). Zeitachse liefert beides.

**Format-Split (wichtig, aus den echten Account-Daten):**
- **TikTok: PHOTO-CAROUSEL** (Carousels performen dort 30-50x besser als Video)
- **Instagram: REEL** (Reels = Reichweite auf IG)
- Gleicher Inhalt, zwei Verpackungen.
...
(Google) - "Mark as Lost". Your phone locks itself and shows a message.

**Minute 5-10 - Block your cards.**
Banking app on any device. From Germany abroad: +49 116 116 blocks
every German card, 24/7, one call.

**Minute 10-15 - Change your email password.**
Email first, always. It is the master key to everything else you own.

**Minute 15-25 - Police report.**
Ask for the case number in writing. Your insurance pays with it - not without.
...
> Your phone is your map, your money, your translator - and thieves know it.
>
> The first 30 minutes, in order:
> 0-5 min: Mark as Lost (Find My works from any browser)
> 5-10 min: block cards - one call: +49 116 116 (German cards, 24/7)
...
- **Bio VORHER fixen (aus Notion, 15 Min):** TikTok-Bio auf
  "free solo travel playbook 💚 / dayatravel.app/l/tt" - ohne Bio-Link ist
  jeder View verschenkt.
